            ...
            <div class="container">
                <?php 
                    for($i = (count($note_list)-1) ; $i >= 0 ; $i--){
                        ...
                        if( $i % 2 == 0){
                            //左文右圖
                            echo '<a href= '.base_url().$note_list[$i]->note_id.'>';
                            ...
                            echo '<h2 class="text-justify text-muted">'.$note_list[$i]->note_summary.'</h2><br><div class="row">';
                            echo '<a href="#"><div class="col-md-7"><h4>類別:'.$note_list[$i]->note_class.'</h4></div></a>';
                            echo '<div class="col-md-5"><h4>建立日期:'.$note_list[$i]->createdate.'</h4></div>';
                            echo '</div></div></div></a><hr>';
                            //左文右圖end
                        }elseif ($i % 2 == 1) {
                            //左圖右文
                            echo '<a href= '.base_url().$note_list[$i]->note_id.'>';
